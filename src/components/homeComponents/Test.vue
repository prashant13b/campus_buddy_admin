<template>
 ...
 <b-field v-if="subject"  label="Test Details">
            <b-input  v-model="testDetail" maxlength="200" type="textarea"></b-input>
        </b-field>
</div>
<div class="column">
    ...
    <div class="has-text-centered">
        ...
        <button @click="submitTest" v-if="testDetail && submissionDate" class="button is-primary">Submit Test </button>
